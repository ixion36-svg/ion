...
**Assessment Date:** 2026-05-13 (v0.30.1 + v0.30.0 deltas) / 2026-05-12 (v0.29.1 + v0.29.0 + v0.28.0 + v0.27.0 + v0.26.1 deltas) / 2026-05-11 (v0.26.0 + v0.25.x + v0.24.0 + v0.23.x + v0.22.1) / 2026-05-09 (v0.22.0-rc body below)
**Application Version:** 0.30.1 (bug-fix patch — MITRE heatmap SQL, case-close sync, auto-PCAP observable linking, nav reorder)
**Previous Assessment Version:** 0.30.0 (2026-05-13)
