...
Current released version: **v0.32.0** (see `pyproject.toml`). Memory above (`~/.claude/projects/.../memory/`) holds the cross-session context; this file is the repo-scoped index. Latest end-of-session handoff: `_handoff_v0_32.md`.
