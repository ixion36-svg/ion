"""OIDC/Keycloak configuration for IXION."""
...
class OIDCConfig:
    ...
    auto_create_users: bool = True  # Auto-create IXION users on first OIDC login
    role_claim: str = "realm_access.roles"  # JWT claim path for roles
    role_mapping: Dict[str, str] = field(default_factory=dict)  # Keycloak -> IXION role mapping
