...
from ixion.services.connectors import get_connector_registry, ConnectorStatus
from ixion.services.webhook_service import get_webhook_service
from ixion.services.integration_log_service import get_integration_log_service
...
async def get_server_log_metrics(
    ...
    try:
        # Query ixion-logs index for stats
        query = {
            "size": 0,
            "query": {
                "bool": {
        ...
        url = f"{es_service.url}/ixion-logs-*/_search"
