"""Multi-alert pattern detection service for IXION.
...
from ixion.services.elasticsearch_service import ElasticsearchAlert
...
def seed_default_playbooks() -> None:
    ...
    from ixion.models.playbook import StepType
    from ixion.storage.user_repository import UserRepository
