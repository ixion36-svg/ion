"""ECS-compliant structured logging for IXION.
...
ECS_SERVICE_NAME = os.environ.get("IXION_SERVICE_NAME", "ixion")
ECS_SERVICE_VERSION = os.environ.get("IXION_VERSION", "1.0.0")
ECS_ENVIRONMENT = os.environ.get("IXION_ENVIRONMENT", "production")
...
def setup_logging(
    ...
    level = os.environ.get("IXION_LOG_LEVEL", level).upper()
    json_output = os.environ.get("IXION_LOG_JSON", str(json_output)).lower() == "true"
    ...
    if elasticsearch_url:
        es_api_key = os.environ.get("IXION_ES_API_KEY")
        es_username = os.environ.get("IXION_ES_USERNAME")
        es_password = os.environ.get("IXION_ES_PASSWORD")
        es_index = os.environ.get("IXION_ES_LOG_INDEX", "ixion-logs")
        es_verify_ssl = os.environ.get("IXION_ES_VERIFY_SSL", "true").lower() == "true"
