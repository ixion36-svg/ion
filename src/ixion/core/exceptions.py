"""Custom exceptions for IXION."""


class IxionError(Exception):
    """Base exception for IXION errors."""

    pass


class TemplateNotFoundError(IxionError):
...
class VersionNotFoundError(IxionError):
...
class ValidationError(IxionError):
...
class ExtractionError(IxionError):
