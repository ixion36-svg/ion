...
from docforge.auth.dependencies import get_current_user, require_permission
...
from docforge.services.security_service import (
    SecurityDetectionService,
    SIEMExportService,
)
from docforge.auth.dependencies import get_db_session
