"""OpenCTI integration service for DocForge.
...
class OpenCTIService:
    ...
    # Map DocForge observable types to OpenCTI STIX types and filter keys
    TYPE_MAP = {
    ...
    async def enrich_observable(
        ...
        Args:
            obs_type: Observable type (e.g., "ipv4-addr", "domain-name",
                      "file-sha256", "url", or DocForge aliases like "source_ip")
