...
from docforge.models.security import SecurityEvent, SecurityEventSeverity
from docforge.storage.security_repository import SecurityEventRepository
from docforge.core.logging import get_structured_logger
...
class SIEMConfig:
    ...
    splunk_source: str = "docforge"
    splunk_sourcetype: str = "docforge:security"
...
class SIEMExporter:
    ...
    def _format_cef(self, event: SecurityEvent) -> str:
        ...
        return (
            f"CEF:0|DocForge|SecurityMonitor|1.0|"
    ...
    def _format_leef(self, event: SecurityEvent) -> str:
        ...
        return (
            f"LEEF:2.0|DocForge|SecurityMonitor|1.0|{event.event_type.value}|"
