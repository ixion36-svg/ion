...
DOMAINS = [
    ...
    },
    {
        ...
        "icon": "users",
        "ion_pages": ["/training", "/shift-handover"],
        "questions": [
            ...
            {"id": "p3", "text": "Is on-call cover documented with defined escalation paths?", "guidance": "Document on-call rosters and escalation paths for your SOC team."},
    ...
    },
    {
        ...
        "questions": [
            ...
            {"id": "r4", "text": "Are post-incident reviews (PIRs) conducted and action items tracked?", "guidance": "Conduct structured PIRs with action items, owners, and due dates after major incidents."},
    ...
    },
    {
        ...
        "questions": [
            ...
            {"id": "s5", "text": "Does the SOC have a continuous improvement backlog driven by PIR actions?", "guidance": "Maintain a backlog of improvement items driven by post-incident reviews and lessons learned."},
        ],
    },
]
